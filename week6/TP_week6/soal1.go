...
func main() {
	...
	fmt.Printf("||  Mobil  ||    Tahun Produksi    ||  Kecepatan  ||\n")
	fmt.Scanln(&m1.merek, &m1.tahunProduksi, &m1.kecepatan)
	fmt.Scanln(&m2.merek, &m2.tahunProduksi, &m2.kecepatan)
	fmt.Scanln(&m3.merek, &m3.tahunProduksi, &m3.kecepatan)
